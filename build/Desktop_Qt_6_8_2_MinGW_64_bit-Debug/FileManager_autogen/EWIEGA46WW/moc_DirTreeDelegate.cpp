...
static constexpr auto qt_meta_stringdata_ZN15DirTreeDelegateE = QtMocHelpers::stringData(
    "DirTreeDelegate"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15DirTreeDelegateE[] = {
...
Q_CONSTINIT const QMetaObject DirTreeDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15DirTreeDelegateE.offsetsAndSizes,
    qt_meta_data_ZN15DirTreeDelegateE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15DirTreeDelegateE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DirTreeDelegate, std::true_type>
    >,
    nullptr
} };
...
void *DirTreeDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15DirTreeDelegateE.stringdata0))
