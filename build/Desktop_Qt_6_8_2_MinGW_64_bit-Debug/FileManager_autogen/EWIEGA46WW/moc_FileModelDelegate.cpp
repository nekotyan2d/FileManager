...
static constexpr auto qt_meta_stringdata_ZN17FileModelDelegateE = QtMocHelpers::stringData(
    "FileModelDelegate"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17FileModelDelegateE[] = {
...
Q_CONSTINIT const QMetaObject FileModelDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17FileModelDelegateE.offsetsAndSizes,
    qt_meta_data_ZN17FileModelDelegateE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17FileModelDelegateE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FileModelDelegate, std::true_type>
    >,
    nullptr
} };
...
void *FileModelDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17FileModelDelegateE.stringdata0))
